    ...
    <Navbar bg="white" expand="lg" className="py-3 shadow-sm sticky-top">
      ...
      <Container className="py-5">
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <Button variant="link" className="text-decoration-none d-flex align-items-center">
      ...
      <div className="position-relative">
        <img src="/api/placeholder/1600/400" className="w-100" alt="Promosi Kesehatan" />
        <div className="position-absolute top-50 start-50 translate-middle text-center text-white bg-dark bg-opacity-50 p-5 rounded">
          <h2 className="fw-bold mb-3">Jaga Kesehatan Anda Bersama KesehatanKU</h2>
          <p className="mb-4">Dapatkan informasi kesehatan terpercaya dan layanan konsultasi dokter</p>
        ...
        <Row className="g-4">
          <Col md={4}>
            <Card className="text-white border-0 shadow-sm">
              <Card.Img src="/api/placeholder/400/250" alt="Kesehatan Jantung" />
              <Card.ImgOverlay className="d-flex align-items-end bg-dark bg-opacity-50">
                <div>
                  ...
                  <Button variant="light" size="sm">Jelajahi</Button>
                </div>
              </Card.ImgOverlay>
            </Card>
          </Col>
                ...
                <Row className="g-0">
                  ...
                  <Col md={6}>
                    <Card.Body>
                      ...
                      <Card.Title className="fw-bold">Waspadai Gejala Stroke Sejak Dini</Card.Title>
                      <Card.Text>
                        Kenali tanda-tanda stroke dan langkah pertolongan pertama yang harus dilakukan untuk mencegah dampak serius.
                      </Card.Text>
                      <Button variant="link" className="text-decoration-none p-0">
                        Baca Selengkapnya
                      </Button>
                ...
                <Row className="g-0">
                  ...
                  <Col md={6}>
                    <Card.Body>
                      ...
                      <Card.Title className="fw-bold">Manfaat Yoga untuk Kesehatan Fisik dan Mental</Card.Title>
                      <Card.Text>
                        Temukan berbagai manfaat yoga bagi kesehatan tubuh dan pikiran Anda dalam rutinitas sehari-hari.
                      </Card.Text>
                      <Button variant="link" className="text-decoration-none p-0">
                        Baca Selengkapnya
                      </Button>
      ...
      <div className="bg-primary text-white py-5">
        <Container className="text-center">
          <h2 className="fw-bold mb-4">KesehatanKU Memberi Anda Informasi yang Paling Dibutuhkan</h2>
          <Row className="g-4">
            <Col md={4}>
              <div className="p-4 bg-white bg-opacity-10 rounded h-100">
                <div className="fs-1 mb-3"><FaUserMd /></div>
                <h4>Terverifikasi Medis</h4>
                <p>Semua informasi kesehatan telah diverifikasi oleh tim dokter profesional kami</p>
              </div>
            </Col>
            <Col md={4}>
              <div className="p-4 bg-white bg-opacity-10 rounded h-100">
                <div className="fs-1 mb-3"><FaStethoscope /></div>
                <h4>Konsultasi Online</h4>
                <p>Terhubung dengan dokter spesialis untuk konsultasi kesehatan Anda kapan saja</p>
              </div>
            </Col>
            <Col md={4}>
              <div className="p-4 bg-white bg-opacity-10 rounded h-100">
                <div className="fs-1 mb-3"><FaHeartbeat /></div>
                <h4>Pemeriksaan Virtual</h4>
                <p>Lakukan pengecekan kesehatan dasar secara online dengan fitur kami yang inovatif</p>
              </div>
            </Col>
          </Row>
          <Button variant="light" size="lg" className="mt-4">Pelajari Lebih Lanjut</Button>
        </Container>
      </div>
