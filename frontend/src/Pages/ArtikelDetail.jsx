...
import { 
  FaHeartbeat, FaSearch, FaBookmark, FaShare, 
      ...
      <div className="bg-primary text-white py-4">
        <Container>
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h1 className="h2 mb-0">Kategori: {categoryName}</h1>
            <div className="d-flex">
              <Button variant="outline-light" size="sm" className="me-2">Daftar</Button>
            ...
            <div className="flex-grow-1">
              <Form>
                <Form.Group className="mb-0 d-flex">
                  <Form.Control
                    type="search"
                    placeholder={`Cari artikel ${categoryName.toLowerCase()}...`}
                    className="rounded-pill"
                  />
                  <Button variant="primary" className="rounded-circle ms-n5 border">
                    <FaSearch />
                  </Button>
                </Form.Group>
              </Form>
        ...
        <Row>
          ...
          <Col lg={8}>
            ...
            <div className="d-flex justify-content-center my-4">
              <Button variant="outline-primary" className="px-4">Lihat Lebih Banyak</Button>
            </div>
          </Col>
          ...
          <Col lg={4}>
            ...
            <Card className="border-0 shadow-sm bg-primary text-white mb-4">
              <Card.Body className="text-center p-4">
                <h3 className="h5 mb-3">Konsultasi dengan Dokter Ahli</h3>
                <p className="small mb-3">Dapatkan jawaban profesional untuk pertanyaan seputar kehamilan Anda.</p>
